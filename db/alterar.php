...
<form action="#" method="post">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="nascimento" id="nascimento" class="form-control <?= $erros['nascimento'] ? 'is-invalid' : '' ?>" placeholder="Nascimento" value="<?= $dados['nascimento'] ?>">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="email" id="email" class="form-control <?= $erros['email'] ? 'is-invalid' : '' ?>" placeholder="E-mail" value="<?= $dados['email'] ?>">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="site" id="site" class="form-control <?= $erros['site'] ? 'is-invalid' : '' ?>" placeholder="Site" value="<?= $dados['site'] ?>">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" name="filhos" id="filhos" class="form-control <?= $erros['filhos'] ? 'is-invalid' : '' ?>" placeholder="Quantidade de filhos" value="<?= $dados['filhos'] ?>">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="salario" id="salario" class="form-control <?= $erros['salario'] ? 'is-invalid' : '' ?>" placeholder="Salário" value="<?= $dados['salario'] ?>">
